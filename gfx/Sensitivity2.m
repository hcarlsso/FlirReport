function [sens, NETD, noise_std]=Sensitivity2(T, sigma, frame_time, integration_time, Frames)
...
[TT, tt, Vout]=RunBolometer2(par, N1,N2,M, sigma);

noise_std=std(Vout(6:end));

M=10;

[TT, tt, Vout2]=RunBolometer2(par, N1,N2,M, 0);

par.Pt=par.As*par.K*(T+1)^4;

[TT2, tt2, Vout3]=RunBolometer2(par, N1,N2,M, 0);

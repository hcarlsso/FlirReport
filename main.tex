...
Ulf W\aa llgren \texttt{ujgwallgren@gmail.com}
}
...
\input{abstract.tex}
\input{introduction.tex}			% Carl
\input{model_and_discretization.tex}		% Giampaolo
\input{noise_model_and_discretization.tex} 	% Håkan Carlsson
\input{numerical_experiments.tex}		% Carl
\input{outlook.tex}				% Carl
